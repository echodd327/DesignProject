...
public class SvnBag {
	    ...
	    public static String destPath = "C:\\bankinfo"; // 放生成的WAR路径  
	    public static String txtPath = "C:\\war.txt"; // 将SVN信息复制到该文本文件中  
	    public static String workPath = "E:\\workspace\\order_20140901\\trademanager-biz-web"; // 注意此目录需配置为服务器目录，eclipse工作目录可能不存在JSP文件  
	            ...
	            {  
	                ...
	                {  
	                    ...
	                    {  
	                        ...
	                        String classDir = workPath + "/src/main/java/WEB-INF/classes" + string.substring(string.indexOf("/src/") + 14, string.lastIndexOf('/'));  
	                        final String destDir = destPath + "/WEB-INF/classes" + string.substring(string.indexOf("/src/") + 14, string.lastIndexOf('/'));  
	                    ...
	                    {  
	                        String sourceFile = workPath + "/src/main/resources/WEB-INF/classes" + string.substring(string.indexOf("/src/") + 19);  
	                        String destFile = destPath + "/WEB-INF/classes" + string.substring(string.indexOf("/src/") + 19);  
